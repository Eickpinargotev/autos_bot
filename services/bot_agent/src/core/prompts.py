...
- También cuenta como intención EXPLÍCITA cuando el turno anterior del bot ofreció opciones de servicio nombradas (p. ej. "¿licencia, clases o alquiler?") y el cliente responde nombrando o seleccionando una de esas opciones, aunque sea con una sola palabra y sin verbo ("teórico", "alquiler", "clases") o señalando su posición en la lista ofrecida ("la primera", "la segunda opción"). Seleccionar una opción ya ofrecida es concretar, no seguir en contexto ambiguo: usa start_flow hacia el flujo elegido, no repitas la aclaración ni la cuentes como una aclaración sin concretar.
